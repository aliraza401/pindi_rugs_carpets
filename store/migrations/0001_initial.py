...
=======
# Generated by Django 3.0.5 on 2020-05-02 12:26
...
<<<<<<< HEAD
                ...
                ('contat_no', models.CharField(max_length=50)),
...
=======
                ...
                ('transaction_id', models.CharField(max_length=350, null=True)),
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.Customer')),
>>>>>>> 5656c02d5a4ca530af0a18ce5ae52133deb031d8
            ],
        ),
        migrations.CreateModel(
...
<<<<<<< HEAD
                ...
                ('calculated_price', models.FloatField(blank=True, default=0, null=True)),
...
=======
                ('quantity', models.IntegerField(blank=True, default=0, null=True)),
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('order', models.ForeignKey(default=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.Order')),
                ('product', models.ForeignKey(default=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.Product')),
>>>>>>> 5656c02d5a4ca530af0a18ce5ae52133deb031d8
            ],
        ),
    ]
